...
function drawChart() {
  ...
  d3.csv("BEZ_Zeitpunkt_Gesuchseinreichung_2025.csv").then(raw => {
    ...
    // ⭐ Ce texte trilingue peut être plus large que l'espace disponible à
    // droite de margin.left — sans ce garde-fou, le SVG (dont la largeur
    ...
    const requiredWidth = margin.left + unitBBox.width + 20;
