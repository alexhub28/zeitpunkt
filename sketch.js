...
function drawChart() {
  ...
  d3.csv("BEZ_Zeitpunkt_Gesuchseinreichung_2025.csv").then(raw => {
    ...
    // ⭐ Légende agrandie pour se rapprocher du poids visuel des labels de
    // ligne (11.5/13.5px, gras) — les puces étaient trop discrètes.
    ...
    // ⭐ Taille alignée sur les labels de ligne du graphique.
